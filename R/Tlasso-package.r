...
#' @author 
#' \tabular{l}{
#'   Will Wei Sun, Zhaoran Wang, Xiang Lyu, Han Liu, Guang Cheng. \cr
...
#'          Sun W, Wang Z, Lyu X, Liu H, Cheng G. \emph{Sparse Tensor Graphical Model: Non-convex Optimization and Statistical Inference.} 2016. arXiv:1609.04522. 
#'     }
#' @name Tlasso
#' @docType package
NULL
